...
//        std::cout << "Calculated mP1...\n";

        double timeEndMUseful = omp_get_wtime();

//        std::cout << "Started timing\n";
//        std::cout << "Sizes of P: " << mProbabilityMatrix.rows() << ", " << mProbabilityMatrix.cols() << std::endl;
//        std::cout << "Sizes of mPt1: " << mPt1.size() << std::endl;
//        std::cout << "Sizes of mP1: " << mP1.size() << std::endl;
//        std::cout << "FixedPointsSize: " << fixedPoints.rows() << ", " << fixedPoints.cols() << std::endl;
